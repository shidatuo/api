        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{ url('admin/index/index') }}" class="site_title"><i class="fa fa-paw"></i> <span>小程序 , 大作为</span></a>
                </div>
                ...
                <div class="profile">
                    ...
                    <div class="profile_info">
                        <span>Welcome,</span>
                        <h2>{!! htmlspecialchars_decode(session('user.name')) !!}</h2>
                    </div>
                </div>
                <!-- /menu profile quick info -->
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="{{ url('admin/oauthUser/index') }}">管理员列表</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="{{ asset(session('user.avatar')) }}" alt="">{!! htmlspecialchars_decode(session('user.name')) !!}
