...
class WxQrcodePay extends WxPayBase {
     ...
     */
    function getXml() {
        if(!empty(WxPayConf::$FWAPPID)&&!empty(WxPayConf::$FWMCHID)){
            $this->parameters ["appid"] = WxPayConf::$FWAPPID; // FW公众账号ID
            $this->parameters ["mch_id"] = WxPayConf::$FWMCHID; // FW公众账号ID
            $this->parameters ["sub_appid"] = WxPayConf::$APPID; // 公众账号ID
            $this->parameters ["sub_mch_id"] = WxPayConf::$MCHID; // 公众账号ID
