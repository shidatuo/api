 ...
 * Class WxPayDataBase
 * @author shidatuo
 * @description 数据对象基础类，该类中定义数据类最基本的行为，包括：
...
class WxPayUnifiedOrder extends WxPayDataBase
{
    ...
    /**
     * 获取上传此参数no_credit--可限制用户不能使用信用卡支付
     * @return 值
     **/
    ...
    /**
     * 判断上传此参数no_credit--可限制用户不能使用信用卡支付
     * @return true 或 false
     **/
    public function IsLimitPaySet()
    {
...
class WxPayDownloadBill extends WxPayDataBase
{
     ...
     * @param string $value
     **/
    public function SetBill_tar_type($value)
    {
     ...
     * @return 值
     **/
    public function GetBill_tar_type()
    {
     ...
     * @return true 或 false
     **/
    public function IsBill_tar_typeSet()
    {
